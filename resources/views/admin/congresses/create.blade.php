    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.congresses.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                ...
                                <div class="mb-2">
                                    <div id="logo-preview" class="hidden mb-2">
                                        <img id="logo-preview-img" src="" alt="Vista previa del logo" class="h-20 w-auto border border-gray-300 rounded-lg p-2 bg-gray-50">
                                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-2">
                                    <div id="banner-preview" class="hidden mb-2">
                                        <img id="banner-preview-img" src="" alt="Vista previa del banner" class="h-32 w-full object-cover border border-gray-300 rounded-lg">
                                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="thematic_areas[]" id="thematic_areas" multiple
                                ...
                                @foreach($thematicAreas as $area)
                                    <option value="{{ $area->id }}" {{ in_array($area->id, old('thematic_areas', [])) ? 'selected' : '' }}>
                                        {{ $area->name }}
                                    </option>
                                @endforeach
                            </select>
